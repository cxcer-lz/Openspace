...
contract NftMarket{
    ...
    event List(uint256 tokenid,uint256 listprice);
    event BuyNFT(uint256 buyamount,uint256 tokenid);
    ...
    function buyNFT(uint256 buyamount,uint256 tokenId) public{
        ...
        require(owner != msg.sender, "You cannot buy your own NFT");
        ...
        emit BuyNFT(buyamount,tokenId);
    }

    function getListing(uint256 tokenId, address owner) public view returns (uint256) {
        return lists[tokenId][owner];
    }
